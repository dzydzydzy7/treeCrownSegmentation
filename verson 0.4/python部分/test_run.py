...
final_rect = co.OSTU_threshold(img_close, 100) #change to 200 is also good
...
local_maxi = peak_local_max(distance, indices=False, footprint=np.ones((35,35)),threshold_abs = 1, labels = binary_rect)
...
ttop = np.array(ttop)
np.savetxt(dic + "img_ttop2.txt", ttop, fmt = "%d") # 1
