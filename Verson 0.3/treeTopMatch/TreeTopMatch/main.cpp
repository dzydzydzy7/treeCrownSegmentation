...
#include <vector>
using namespace std;
#define LEFT 378072.015
#define BOTTOM 4410418.398
#define WIDTH 1406
#define HEIGHT 646
...
void init(vector<TreeTop>& manual, vector<TreeTop>& algo)
{
	...
	segIn.close();
	ifstream manualIn("manual.txt");
	ifstream algoIn("cttop.txt");//读入矩阵就搜索每一个点的号，x值平均，y值pj作为输入
